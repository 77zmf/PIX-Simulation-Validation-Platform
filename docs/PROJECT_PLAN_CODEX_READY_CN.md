...
### 1.3 非目标
- 本季度不做直接端到端控制接管。
- 本季度不以大规模高保真公开道路生产验证为目标。
- 本季度不追求一次做完动态 Gaussian、全量场景库和外部系统自动同步。
...
- **完成标志**：
  ...
  - 下季度可在不重设计架构前提下扩展 `E2E shadow on CARLA 0.9.15 / UE4.26`
