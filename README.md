...
- keep NovaDrive, SUMO, calibration, and L3 probes as repo-side validation extensions until Ubuntu-host execution evidence exists
...
- [NovaDrive System Design](./docs/NOVADRIVE_SYSTEM_DESIGN_CN.md)
- [NovaDrive Roadmap](./docs/NOVADRIVE_ROADMAP_CN.md)
- [Lidar Calibration Validation](./docs/runbooks/lidar_calibration_validation.md)
...
- `docs/NOVADRIVE_SYSTEM_DESIGN_CN.md`
- `docs/NOVADRIVE_ROADMAP_CN.md`
- `docs/runbooks/lidar_calibration_validation.md`
...
- NovaDrive, SUMO, calibration, and L3 stress work remains repo-side until real Ubuntu-host evidence is attached.
