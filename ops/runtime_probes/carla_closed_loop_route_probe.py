...
OPERATION_MODE_BLOCKER_TOPIC_SPECS: tuple[tuple[str, str, str | None], ...] = (
    ...
    ("component_autonomous_sensing", "/system/component_state_monitor/component/autonomous/sensing", None),
    ("component_autonomous_vehicle", "/system/component_state_monitor/component/autonomous/vehicle", None),
    ("component_autonomous_localization", "/system/component_state_monitor/component/autonomous/localization", None),
    ("component_autonomous_map", "/system/component_state_monitor/component/autonomous/map", None),
    ("component_autonomous_perception", "/system/component_state_monitor/component/autonomous/perception", None),
    ("component_autonomous_planning", "/system/component_state_monitor/component/autonomous/planning", None),
    ("component_autonomous_control", "/system/component_state_monitor/component/autonomous/control", None),
    ("component_autonomous_system", "/system/component_state_monitor/component/autonomous/system", None),
    ("component_launch_sensing", "/system/component_state_monitor/component/launch/sensing", None),
    ("component_launch_vehicle", "/system/component_state_monitor/component/launch/vehicle", None),
    ("component_launch_localization", "/system/component_state_monitor/component/launch/localization", None),
    ("component_launch_map", "/system/component_state_monitor/component/launch/map", None),
    ("component_launch_perception", "/system/component_state_monitor/component/launch/perception", None),
    ("component_launch_planning", "/system/component_state_monitor/component/launch/planning", None),
    ("component_launch_control", "/system/component_state_monitor/component/launch/control", None),
    ("component_launch_system", "/system/component_state_monitor/component/launch/system", None),
