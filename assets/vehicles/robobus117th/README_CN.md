...
- `scenarios/l0/robobus117th_vehicle_blueprint_acceptance.yaml` 能把 bbox/collision、轮胎几何和传感器挂载写入 KPI；2026-04-25 已修复 CARLA API bbox 并通过独立 strict bbox 动态验收，原生 PIX PhysicsAsset/collision proxy 仍是后续增强项。
