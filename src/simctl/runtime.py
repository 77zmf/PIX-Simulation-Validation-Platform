...
def build_context(
    ...
    context = {
        ...
        "carla_bridge_timeout": runtime_option("carla_bridge_timeout", "90"),
        ...
        "pix_carla_creep_throttle": runtime_option("pix_carla_creep_throttle"),
        "pix_carla_creep_speed_threshold_mps": runtime_option("pix_carla_creep_speed_threshold_mps"),
        ...
        "stable_preflight_min_mem_available_gb": runtime_option("stable_preflight_min_mem_available_gb", "1"),
        "stable_preflight_min_swap_free_gb": runtime_option("stable_preflight_min_swap_free_gb", "2"),
        ...
        "carla_localization_bridge_source": runtime_option(
            "carla_localization_bridge_source",
            "topics",
        ),
        ...
        "sumo_carla_client_timeout_sec": runtime_option("sumo_carla_client_timeout_sec", "20.0"),
